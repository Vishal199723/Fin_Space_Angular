...
@Component({
  selector: 'app-ppudashboard',
  templateUrl: './ppudashboard.component.html',
  styleUrls: ['./ppudashboard.component.css']
})
export class PPUDashboardComponent implements OnInit {
  ...
  constructor(private messageService: MessageService,private router:Router,private spinner:NgxSpinnerService,private admindashboardservice:AdminDashboardService,
    private roleService:RoleService,private datepipe:DatePipe) {
  ...
  async PendingServices(){
    ...
    this.spinner.show();
    this.admindashboardservice.GetPPUPendingServices(data).subscribe((data:any)=>{
  ...
  async CompletedServices(){
    ...
    this.spinner.show();
    this.admindashboardservice.GetPPUCompletedServices(data).subscribe((data:any)=>{
  ...
  async NewServices(){
    ...
    this.spinner.show();
    this.admindashboardservice.GetPPUNewServices(data).subscribe((data:any)=>{
