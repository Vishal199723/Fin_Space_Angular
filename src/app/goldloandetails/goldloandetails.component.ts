...
@Component({
  selector: 'app-goldloandetails',
  templateUrl: './goldloandetails.component.html',
  styleUrls: ['./goldloandetails.component.css'],
  providers: [{
    provide: STEPPER_GLOBAL_OPTIONS, useValue: { displayDefaultIndicatorType: false }
  }]
})
export class GoldloandetailsComponent implements OnInit {
  submitted: boolean;
  alldetails: any;
  familyDetails: any;
  ...
  backendServices() {
    ...
    this.businessService.getBusinessLoanDetailsUser(this.userdetailsfor).subscribe((response: any) => {
      ...
      if (this.alldetails.goldLoanDetails != null || this.alldetails.goldLoanDetails != undefined) {
        ...
        else if(this.goldLoanDetails.goldType == 2){
          this.goldType ="Overdraft Facility";
        }
        else {
          this.goldType ="Bullet Laon";
        }
      }
