...
@Component({
  selector: 'app-fixedassetloandetails',
  templateUrl: './fixedassetloandetails.component.html',
  styleUrls: ['./fixedassetloandetails.component.css'],
  providers: [{
    provide: STEPPER_GLOBAL_OPTIONS, useValue: { displayDefaultIndicatorType: false }
  }]
})
export class FixedassetloandetailsComponent implements OnInit {
  ...
  fixedassetloan(stepper: MatStepper) {
    this.submitted = true;
    stepper.next();
  }
  GetStatusList() {
