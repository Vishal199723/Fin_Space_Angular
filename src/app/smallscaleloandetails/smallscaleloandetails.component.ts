...
@Component({
  selector: 'app-smallscaleloandetails',
  templateUrl: './smallscaleloandetails.component.html',
  styleUrls: ['./smallscaleloandetails.component.css'],
  providers: [{
    provide: STEPPER_GLOBAL_OPTIONS, useValue: { displayDefaultIndicatorType: false }
  }]
})
export class SmallscaleloandetailsComponent implements OnInit {
  submitted: boolean;
  alldetails: any;
  familyDetails: any;
  ...
  constructor(private messageService: MessageService,private businessService: BusinessLoanServiceService,private spinner: NgxSpinnerService,
    ...
    private httpservice:HttpClient,private route: Router,) { 
  ...
  smallscaleloan(stepper: MatStepper) {
    this.submitted = true;
    stepper.next();
  }
  GetStatusList() {
