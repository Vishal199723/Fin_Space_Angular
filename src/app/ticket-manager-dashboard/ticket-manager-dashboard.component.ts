...
@Component({
  selector: 'app-ticket-manager-dashboard',
  templateUrl: './ticket-manager-dashboard.component.html',
  styleUrls: ['./ticket-manager-dashboard.component.css']
})
export class TicketManagerDashboardComponent implements OnInit {
  uid: string;
  p: number = 1;
  showhidevalue = false;
  ...
  gotoppulist() {
    this.router.navigate(["/ppucustlist"])
  }
  ...
  AssignedServicesTrue() {
    ...
    this.router.navigate(['/TMdashboarddetails/' + 1])
  }
  ResolvedServicesTrue() {
    this.router.navigate(['/TMdashboarddetails/' + 2])
  }
