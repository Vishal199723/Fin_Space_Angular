...
@Component({
  selector: 'app-vehicleloanform',
  templateUrl: './vehicleloanform.component.html',
  styleUrls: ['./vehicleloanform.component.css'], providers: [{
    provide: STEPPER_GLOBAL_OPTIONS, useValue: { displayDefaultIndicatorType: false }
  }]
})
export class VehicleloanformComponent implements OnInit {
  ...
  casteid: any;
  quaid: any;
  occuid: any; desid: any; fid: any;
  hid: any; caid: any; banks: any;
  repaid: any;
  Instalment: any;
  driving: any;
  Share: any;
  ...
  username: any;
  uid: any; guardioanrelationshipwithminorid: any;
  DateTime: Date; guardianname: any;
  ...
  minorpincode: any
  Naddress2: any;
  Npincode: any; selectedchequetype: any;
  ...
  get g() { return this.vehicalloanForm1.controls; }
  get v() { return this.vehicalloanForm2.controls; }
  ...
  vehicalloanForm1 = new FormGroup({
    customerid: new FormControl(),
    repaid: new FormControl(),
  ...
  vehicalloanForm2 = new FormGroup({
    customerid: new FormControl(),
    applicant: new FormControl(),
    towards: new FormControl(),
    enclose: new FormControl(),
  ...
  constructor(private messageService: MessageService,private formBuilder: FormBuilder, private http: HttpClient, private countryService: CountryService,
    ...
    this.vehicalloanForm1 = formBuilder.group({
      repaid: ['', Validators.required],
      Instalment: ['', Validators.required],
      driving: ['', Validators.required],
      Furnish: ['', Validators.required],
      Residential: ['', Validators.required],
      Directors: ['', Validators.required],
      loaamt: ['', Validators.required],
      loanac: ['', Validators.required],
    ...
    this.vehicalloanForm2 = formBuilder.group({

      applicant: ['', Validators.required],
      towards: ['', Validators.required],
      enclose: ['', Validators.required],
...
if (this.editformname == "personal") {
...
else if (this.editformname == "vehicle") {
  this.GetEditData();
  this.enablepreview = true;
  ...
  async GetEditData() {
    ...
    this.businessloanservice.GetVehicleLoanEditdata(sendid).subscribe((data: any) => {
      this.spinner.hide();
      ...
      if (data.vehicleLoanDetails != null) {
        if (data.vehicleLoanDetails.vehicaltype == 1) {
          this.newvehicle = true
          this.oldvehicle = false;
        }
        else {
        ...
        this.vehicaltype = data.vehicleLoanDetails.vehicaltype
        this.repaid = data.vehicleLoanDetails.repaid;
        this.Instalment = data.vehicleLoanDetails.instalment;
        this.driving = data.vehicleLoanDetails.driving;
        this.Furnish = data.vehicleLoanDetails.furnish;
        this.Residential = data.vehicleLoanDetails.residential;
        this.Directors = data.vehicleLoanDetails.directors;
        this.loaamt = data.vehicleLoanDetails.loaamt;
        this.loanac = data.vehicleLoanDetails.loanac;
        this.Outstanding = data.vehicleLoanDetails.outstanding;
        this.Christian = data.vehicleLoanDetails.christian;
        this.purchased = data.vehicleLoanDetails.purchased;
        this.inclusive = data.vehicleLoanDetails.inclusive;
        this.Passenger = data.vehicleLoanDetails.passenger;
        this.vehicleuse = data.vehicleLoanDetails.vehicleuse;
        this.authorised = data.vehicleLoanDetails.authorised;
        this.payment = data.vehicleLoanDetails.payment;
        this.delivery = data.vehicleLoanDetails.delivery;
        this.applicant = data.vehicleLoanDetails.applicant;
        this.towards = data.vehicleLoanDetails.towards;
        this.enclose = data.vehicleLoanDetails.enclose;
        this.particulars = data.vehicleLoanDetails.particulars;
        this.Share = data.vehicleLoanDetails.share;
        this.cashloan = data.vehicleLoanDetails.cashloan;
        this.Partnersloan = data.vehicleLoanDetails.partnersloan;
        this.acnumber = data.vehicleLoanDetails.acnumber;
        this.owner = data.vehicleLoanDetails.owner;
        this.Registration = data.vehicleLoanDetails.registration;
        this.modelname = data.vehicleLoanDetails.modelname;
        this.Agreed = data.vehicleLoanDetails.agreed;
        this.finishloan = data.vehicleLoanDetails.finishloan;
        this.Balance = data.vehicleLoanDetails.balance;
        ...
        this.businessloanservice.SaveBasicDetails(data).subscribe((data: any) => {
          if (data == "success") {
            ...
            if (localStorage.getItem("editloanform") != "false" && (this.ticketid == null || this.ticketid == undefined || this.ticketid == "")) {
              this.route.navigate(['/vehicledetails'])
        ...
        this.httpService.post('http://applicationapi-dev.ap-south-1.elasticbeanstalk.com/api/C_BankandIdentityDetails/PostBankIdentityDetails/', frmData).subscribe(
          data => {
            if (data == "success") {
              ...
              this.spinner.hide();
              if (localStorage.getItem("editloanform") != "false" &&(this.ticketid==null||this.ticketid==undefined||this.ticketid=="")) {
                this.route.navigate(['/vehicaldetails'])
  ...
  SaveVehicleDraft() {
    if (this.role == '1008') {
      ...
      this.businessloanservice.SaveVehicleLoanDetails(cdata).subscribe((data: any) => {
        if (data == "success") {
          this.notify = "Vehicle Loan Details Saved Successfully!!"
          setTimeout(() => this.dismissalert = true, 100);
          setTimeout(function () {
            this.dismissalert = false;
          }.bind(this), 3000);
      ...
      this.spinner.show();
      this.businessloanservice.SaveVehicleLoanDetails(data).subscribe((data: any) => {
        if (data == "success") {
          this.notify = "Vehicle Loan Details Saved Successfully!!"
          setTimeout(() => this.dismissalert = true, 100);
          setTimeout(function () {
  ...
  vehicleIn(stepper: MatStepper) {
    if (this.role == '1008') {
      this.submitted = true;
      if (this.vehicaltype == 1 && this.vehicalloanForm1.invalid) {
        return;
      }
      else if (this.vehicaltype == 2 && this.vehicalloanForm2.invalid) {
        return;
  ...
  GetDraftData() {
    ...
    this.spinner.show();
    this.businessloanservice.GetvehicleDraftdata(sendid).subscribe((data1: any) => {
      ...
      else if (data.count == 4 && data.vehicleLoanDetails == null) {
        this.stepper1.selectedIndex = 4;
      }
      else if (data.count == 4 && data.vehicleLoanDetails != null) {
        if (data.vehicleLoanDetails.vehicaltype == 1) {
  ...
  previewloandetails(){
    ...
    this.route.navigate(['previewloandetails/' + "vehicle"]);
  }
  ...
  submitloanform() {
    ...
    var cdata = {
      ...
      SendCopytoSP: this.SendCopytoSP,
      UserId: this.uid,
      RequestType: 3,//Vehicle,
      Information:"Vehicle Loan"
    }
    this.spinner.show();
    this.businessloanservice.SubmitLoanForm(cdata).subscribe((data: any) => {
      if (data == "ok") {
        if (this.role == '1008') {
          ...
          alert("Vehicle Form Submitted Successfully with ticket ID " + this.ticketid + " and to ServcieProvider " + this.serviceprovidername)
          this.route.navigate(['/customerdashboard']);
