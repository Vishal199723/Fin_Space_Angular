...
@Component({
  selector: 'app-ppu-loandocumentation',
  templateUrl: './ppu-loandocumentation.component.html',
  styleUrls: ['./ppu-loandocumentation.component.css']
})
export class PpuLoandocumentationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.userticketid = localStorage.getItem("ppuloandocdata");
  ...
  GetDatafromLoanApplicationProposaltable() {
    this.spinner.show()
    this.mailservice.ppuloanapplicationdata(this.CustId).subscribe((data: any) => {
      this.Loanapplicationdata = data;
      this.ppuid = this.Loanapplicationdata.ppuid;
      this.customerid = this.Loanapplicationdata.customerId;
      this.firstname = this.Loanapplicationdata.customerName;
      this.spinner.hide()
    })
  }
  GetDocuments() {
  ...
  GetCustomersanctionedAmount() {
    this.spinner.show()
    this.mailservice.getppusanctionedamount(this.CustId).subscribe((respose: any) => {
      this.spinner.hide();
  ...
  SavePPULoanDocumentationWrkflwDetails = function () {
